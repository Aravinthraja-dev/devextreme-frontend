...
export * from './library/customer/customer.component';
export * from './library/vendor/vendor.component';
export * from './library/header-highlighter/header-highlighter.component';
